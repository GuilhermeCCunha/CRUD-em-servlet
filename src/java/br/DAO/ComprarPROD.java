...
public class ComprarPROD {
    ...
    public void Alterar(Produto produto) throws Exception {
        Conexao conexao = new Conexao();
        try {
            PreparedStatement sql = conexao.getConexao().prepareStatement("INSERT INTO PRODUTONOCARRINHO (id,idcategoria, nome, descricao,valor) VALUES (?,?,?,?,?)");
    ...
    public void Excluir(Produto produto) throws Exception {
        Conexao conexao = new Conexao();
        try {
            PreparedStatement sql = conexao.getConexao().prepareStatement("DELETE FROM PRODUTONOCARRINHO WHERE ID = ? ");
            sql.setInt(1, produto.getId());
            sql.executeUpdate();
    ...
    public ArrayList<Produto> Listar() {
        ArrayList<Produto> meuCarrinho = new ArrayList();
        Conexao conexao = new Conexao();
        try {
            String selectSQL = "SELECT * FROM PRODUTONOCARRINHO";
